...
const enLabels: Record<string, string> = {
  ...
  "봇 허브":"Bot Hub","봇 허브 구성":"Bot Hub composition","봇 허브 목록":"Bot Hub list","봇 허브 설정":"Bot Hub settings","봇 허브 재학습":"Bot Hub retraining",
  ...
  "버튼명":"Button name","버튼 표시명":"Button display name","선택 시 메시지":"Message on selection","순서":"Order","추천 순서":"Recommendation order","표시명":"Display name",
  ...
  "파일 업로드":"Upload file","파일 다운로드":"Download file","파일 메뉴":"File menu","필터":"Filter","전체 결과":"All results","더보기":"More","처음으로":"First","재학습":"Retraining","학습 반영":"Apply training",
  "사용자 발화":"User utterance","처리 결과":"Processing result","학습상태":"Training status","학습 완료 시간":"Training time","발생 일시":"Occurred at","등록일자":"Registered at","등록자":"Created by","최종수정일시":"Last modified","최종수정자":"Modified by",
