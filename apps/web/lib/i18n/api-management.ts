...
export const API_MANAGEMENT_CATALOGS = {
  ko: {
    ...
    response: "파라미터 응답", notFound: "API 정보를 찾을 수 없습니다.", confirmDelete: "API를 삭제하시겠습니까?", loadFailed: "API 목록을 불러오지 못했습니다.", createForbidden: "API 등록 권한이 없습니다.", editForbidden: "API 수정 권한이 없습니다.", saveFailed: "API 저장 중 오류가 발생했습니다.", downloadSelectionRequired: "다운로드할 API를 선택해주세요.", downloadEmpty: "다운로드할 API가 없습니다.", downloadedSelected: "{count}개 API를 다운로드했습니다.", downloadedAll: "전체 API를 다운로드했습니다.", uploadEmpty: "업로드할 API 데이터가 없습니다.", uploaded: "{count}개 API를 업로드했습니다.", uploadReadFailed: "API 업로드 파일을 읽지 못했습니다.", updated: "API가 수정되었습니다.", created: "API가 등록되었습니다.", deletedSelected: "선택한 API가 삭제되었습니다.",
  },
  en: {
