...
export const ADMIN_COMMON_CATALOGS = {
  ko: {
    ...
    totalCount: "전체 {count}건", pageSize: "{count}개씩 보기", download: "다운로드", selectItem: "{name} 선택",
  },
  en: {
    ...
    totalCount: "Total {count}", pageSize: "{count} per page", download: "Download", selectItem: "Select {name}",
  },
  "zh-CN": {
    ...
    totalCount: "共 {count} 条", pageSize: "每页 {count} 条", download: "下载", selectItem: "选择 {name}",
  },
  ja: {
    ...
    totalCount: "全 {count} 件", pageSize: "{count}件ずつ表示", download: "ダウンロード", selectItem: "{name}を選択",
  },
  vi: {
    ...
    totalCount: "Tổng {count}", pageSize: "{count} mỗi trang", download: "Tải xuống", selectItem: "Chọn {name}",
  },
  fr: {
    ...
    totalCount: "Total {count}", pageSize: "{count} par page", download: "Télécharger", selectItem: "Sélectionner {name}",
  },
  de: {
    ...
    totalCount: "Gesamt {count}", pageSize: "{count} pro Seite", download: "Herunterladen", selectItem: "{name} auswählen",
  },
